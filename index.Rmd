...
- 標題為**油電業薪資近9萬，是教服業的4倍?**。

- include table of contents

<img src="images/html_default.png" alt="logo" height="100">
...
<img src="images/html_add_section.png" alt="logo" height="250">
...
- [報告範例](http://rpubs.com/mansun_kuo/24482)
- [Rmd File](https://github.com/mansunkuo/rmd_tutorial/blob/master/r_markdown_exercise.Rmd)
- 主題
    - 油電業薪資近9萬，是教服業的4倍？
    - 實質薪資倒退十五年？
- 小提示
    - 利用knitr::opts_chunk$set將整份報告的warning設為FALSE
      來處理中文問題
    - 繪製"油電業薪資近9萬，是教服業的4倍？"時，
      設定dpi=75, fig.width=10
    - 試著隱藏source code
